  ...
  return (
    <div className={styles.mainPage}>
      <div className={styles.app}>
        ...
        <InputSlider name='Hinta(€)' value={priceRange} setValue={setPriceRange} min={0} max={4000} step={5} valueLabelDisplay="on" marks={[{value: 100, label: "100€"}, {value: 500, label: "500€"}, {value:1000, label:"1000€"}, {value: 2000, label: "2000€"}, {value:3000, label:"3000€"}, {value:4000, label:"4000€"}]}/>
